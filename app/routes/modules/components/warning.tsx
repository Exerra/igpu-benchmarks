...
export default class ReviewWarning extends React.Component<any, any> {
	render() {
		return (
			<div className={"bg-gray-200 p-10 rounded-2xl bg-center bg-cover lg:flex lg:justify-between items-center mt-10 bg-orange-100/50"}>
				<div>
				...
				<div className={"hidden lg:inline max-w-xl bg-white p-5 mt-5 lg:mt-0 md:p-5 rounded-2xl shadow-2xl aspect-square"}>
					<p className={"text-7xl text-orange-400"}><i className="fa-solid fa-triangle-exclamation"></i></p>
				</div>
			</div>
		);
	}
